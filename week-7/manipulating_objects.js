...
// Knowing when to creat a new a hash from reading the error messages on terminal. But after going back to canvas to look through the challenge again, I knew to create a hash. Once I placed {}'s it gave me a new error message which I knew it worked.

// How difficult was it to add and delete properties outside of the object itself?

// It was really easy to add and delete properties outside the object of the object.  It felt very natural, much like methods in ruby. But even easier to do so, by selecting the object and adding the property after it with its new value.

// What did you learn about manipulating objects in this challenge?
//
//That I am able to add and delete propieties from outside the object itself. Also what is cool is that I am able to add an object such as an array or hash and add it to the object itself from outside the object.
//
//
